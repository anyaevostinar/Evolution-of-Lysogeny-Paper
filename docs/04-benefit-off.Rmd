# Benefit Off
The following includes the R scripts that we used to generate our graphs for the data where the potential benefit to the hosts of lysogenic phage was turned off.

## Gather Settings and Treatments

General settings
```{r}
folder <- "BenefitOff/" #Folder where datafiles are 
